...
const PlayersList = ({store, color}) => {
	...
	return <div className="mafia-menu-players-list">
		<PlayersListHeader store={store}/>
		<div className="mafia-menu-players-list-content">
			<div className="mafia-menu-players-list-content-header">
				<div
					className="mafia-menu-players-list-content-header__element mafia-menu-players-list-content-header__element_rank">Ранг
				</div>
				<div
					className="mafia-menu-players-list-content-header__element mafia-menu-players-list-content-header__element_id">ID
				</div>
				<div
					className="mafia-menu-players-list-content-header__element mafia-menu-players-list-content-header__element_nickname">Имя
				</div>
				<div
					className="mafia-menu-players-list-content-header__element mafia-menu-players-list-content-header__element_rank-name">Должность
				</div>
				<div
					className="mafia-menu-players-list-content-header__element mafia-menu-players-list-content-header__element_online">Online
				</div>
				<div
					className="mafia-menu-players-list-content-header__element mafia-menu-players-list-content-header__element_capt">Бизвар
				</div>
				<div
					className="mafia-menu-players-list-content-header__element mafia-menu-players-list-content-header__element_edit">Управление
				</div>
			</div>
			<div
				className={cn('mafia-menu-players-list-content-list', editData.visible ? 'mafia-menu-players-list-content-list_editing' : null)}>
				{store.filteredPlayersList.slice().sort((a, b) => b.rank - a.rank).sort((a, b) => b.isOnline - a.isOnline).map((el, key) => {
					return <div
						key={key}
						className="mafia-menu-players-list-content-list-element"
						style={editData.data?.id === el.id ? {background: `linear-gradient(135deg, #21212166, #FFFFFF15, ${color}66)`} : null}
					>
						<div className="mafia-menu-players-list-content-list-element__rank">{el.rank}</div>
						<div className="mafia-menu-players-list-content-list-element__id">{el.id}</div>
						<div className="mafia-menu-players-list-content-list-element__nickname">{el.nickname}</div>
						<div
							className="mafia-menu-players-list-content-list-element__rank-name">{store.ranks[el.rank - 1].name}</div>
						<div className="mafia-menu-players-list-content-list-element-online">
							{el.isOnline ?
								<div className="mafia-menu-players-list-content-list-element-online__status"/> :
								<div
									className="mafia-menu-players-list-content-list-element-online__date">{el.onlineLogs.filter(el => el.time > 0)[0].date}</div>}
						</div>
						<div
						...
						<img
							className="mafia-menu-players-list-content-list-element__edit"
							src={editIcon}
							alt="#"
							onClick={() => {
		...
		<div
			className={cn('mafia-menu-players-list-content-edit', editData.visible ? 'mafia-menu-players-list-content-edit_active' : null)}>
			<div className="mafia-menu-players-list-content-edit-player">
				<img className="mafia-menu-players-list-content-edit-player__person" src={person} alt="#"/>
				<div className="mafia-menu-players-list-content-edit-player-header">
					<div
						className="mafia-menu-players-list-content-edit-player-header__id">ID: {editData.data?.id}</div>
					{editData.data?.punishment[0] &&
					<div className="mafia-menu-players-list-content-edit-player-header__ban">Ban</div>}
					{editData.data?.punishment[1] &&
					<div className="mafia-menu-players-list-content-edit-player-header__jail">Jail</div>}
					{editData.data?.punishment[2] &&
					<div className="mafia-menu-players-list-content-edit-player-header__mute">Mute</div>}
				</div>
				<div className="mafia-menu-players-list-content-edit-player-name">{editData.data?.nickname}</div>
				<div className="mafia-menu-players-list-content-edit-player-stat">
					<div
						className="mafia-menu-players-list-content-edit-player-stat__online"
					...
					<div className="mafia-menu-players-list-content-edit-player-stat__rank">
						{store.ranks[editData.data?.rank - 1]?.name}
					</div>
				</div>
				<div className="mafia-menu-players-list-content-edit-player-reputation">
					<div className="mafia-menu-players-list-content-edit-player-reputation-rank">
						<img
							className="mafia-menu-players-list-content-edit-player-reputation-rank__change
					...
					<div className="mafia-menu-players-list-content-edit-player-reputation-reprimands">
						<span className="mafia-menu-players-list-content-edit-player-reputation-reprimands__count">
							{reprimandCount}
						</span>
						выговоров
					</div>
				</div>
				<div className="mafia-menu-players-list-content-edit-player-online">
					{editData.data?.onlineLogs.map((el, key) => {
						const time = el.time >= 60 ? `${(el.time / 60).toFixed(0)}ч` : `${el.time}мин`;
						
						return <div key={key} className="mafia-menu-players-list-content-edit-player-online-element">
							<div className="mafia-menu-players-list-content-edit-player-online-element__date">
								{el.date}
							</div>
							<div
								className="mafia-menu-players-list-content-edit-player-online-element__time"
				...
				<div className="mafia-menu-players-list-content-edit-player__join-date">
