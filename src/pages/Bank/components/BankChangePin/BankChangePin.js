...
const BankChangePin = ({player}) => {
	...
	const changePin = React.useCallback(() => {
		EventManager.emitServer('bank', 'changePin', currentPin.current.value, newPin.current.value, rePin.current.value);
		...
		<div className="bank-change-pin-content">
			...
			<div className="bank-change-pin-content-info">
				...
				<div className="bank-change-pin-content-info-card">
					<div className="bank-change-pin-content-info-card__type">{player.playerState.bank.name}
