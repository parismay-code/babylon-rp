...
const BankTransfer = ({customEvent, store, player}) => {
	...
	const handleTransfer = React.useCallback(() => {
		EventManager.emitServer('bank', 'transfer', account.current.value, value.current.value);
	}, []);
		...
		<div className="bank-transfer-header">
			<div className="bank-transfer-header-info">
				...
				<div className="bank-transfer-header-info-card">
					<div className="bank-transfer-header-info-card__title">{player.playerState.bank.name}
			...
			<div className="bank-transfer-header-form">
				...
				<div className="bank-transfer-header-form-input">
					<input className="bank-transfer-header-form-input__count" type="number" name="n_withdrawCount"
					       placeholder="Счет" ref={account}/>
				</div>
			</div>
			<div className="bank-transfer-header-form">
				<div className="bank-transfer-header-form__description">
