...
const CrimeMenu = ({store}) => {
	...
	return <div ref={screen} className="crime-menu">
		<div className="crime-menu-header">
			<div className="crime-menu-header__top-light"
			     style={{background: `radial-gradient(closest-side at 50% 50%, ${fractionColor}99, #FFFFFF00)`}}/>
			<div className="crime-menu-header__title">{store.fractionName}</div>
		...
		{currentPage === 'main' && <div className="crime-menu-content">
			...
			<div className="crime-menu-content-right">
				<div className="crime-menu-content-right-navigation">
					<svg
						className="crime-menu-content-right-navigation__players"
					...
					>
						<path
							...
							transform="translate(0 -2.25)" fill={currentComponent === 'players' ? '#eaeaea' : '#000000'}
							opacity={currentComponent === 'players' ? 1 : .5}/>
					</svg>
					<svg
						className="crime-menu-content-right-navigation__cars"
						xmlns="http://www.w3.org/2000/svg"
						width="33.75"
						height="27"
						viewBox="0 0 33.75 27"
						onClick={() => setComponent('cars')}
					>
						<path
					...
					<svg
						className="crime-menu-content-right-navigation__ranks"
						xmlns="http://www.w3.org/2000/svg"
						width="30"
						height="29.995"
					...
					<svg
						className="crime-menu-content-right-navigation__store"
						xmlns="http://www.w3.org/2000/svg"
						width="31.69"
						height="29.499"
						...
						onClick={() => {
							...
							window.alt.emit('client::crimeMenu:lockStore', store.isStoreLocked);
						}}
					>
						<path
		...
		<div className="crime-menu-footer">
			<div className="crime-menu-footer__top-line"
			     style={{background: `linear-gradient(to right, #FFFFFF00, #FFFFFF, ${fractionColor})`}}/>
			<div className="crime-menu-footer-exit">
				<div className="crime-menu-footer-exit__button">Esc</div>
				<span className="crime-menu-footer-exit__text">- выход</span>
			</div>
			<img className="crime-menu-footer__icon" src={fractionIcon} alt="#"/>
		</div>
	</div>;
};

export default observer(CrimeMenu);