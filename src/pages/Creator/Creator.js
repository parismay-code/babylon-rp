        ...
        <div className="creator">
            <div className="creator__content">
                ...
                <div className="creator-controls">
                    <div className="creator-controls-camera">
                        <img
                            className="creator-controls-camera__icon"
                            src={arrows}
                            alt="#"
                        />
                        <div className="creator-controls-camera__title">
                            Управление камерой
                        </div>
                    </div>
                    <div className="creator-controls-rotate">
                        <img
                            className="creator-controls-rotate__icon"
                            src={mouse}
                            alt="#"
                        />
                        <div className="creator-controls-rotate__title">
                            Вращение персонажа
                        </div>
                    </div>
                </div>
