...
const Nose = ({store}) => {
    ...
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 0, store.data.face.noseWidth);
    }, [store.data.face.noseWidth])
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 1, store.data.face.nosePeakHeight);
    }, [store.data.face.nosePeakHeight])
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 2, store.data.face.nosePeakLength);
    }, [store.data.face.nosePeakLength])
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 3, store.data.face.noseBoneHeight);
    }, [store.data.face.noseBoneHeight])
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 4, store.data.face.nosePeakLowering);
    }, [store.data.face.nosePeakLowering])
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 5, store.data.face.noseBoneTwist);
