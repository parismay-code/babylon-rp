...
const Other = ({store}) => {
    ...
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 12, store.data.face.lips);
    }, [store.data.face.lips])
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 13, store.data.face.jawBoneWidth);
    }, [store.data.face.jawBoneWidth])
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 14, store.data.face.jawBoneBackLength);
    }, [store.data.face.jawBoneBackLength])
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'face', 19, store.data.face.neckWidth);
