		...
		<div className="player-clothes">
			...
			<div className="player-options">
				...
				<div className="player-options-list">
					<div key="k_clothesHead" className="player-options-list__element select-element">
					...
					<div style={{marginBottom: '1.5vw'}} key="k_clothesHeadTexture"
					     className="player-options-list__element player-options-list__element_cloth range-element">
						<span>цвет</span>
						<div className="range-element__input">
							...
							<input
								type="range"
								min="0"
								max={getElementByDrawable(clothesArray(sex, 0), store.data.clothes.head.drawable)?.textures.length - 1}
								value={getElementByDrawable(clothesArray(sex, 0), store.data.clothes.head.drawable)?.textures.indexOf(store.data.clothes.head.texture)}
								onChange={(e) => {
									const textures = getElementByDrawable(clothesArray(sex, 0), store.data.clothes.head.drawable).textures;
									
									store.data.clothes.head.texture = textures[Number(e.target.value)];
								}}/>
							<img className="right-arrow" src={arrow} alt="#" onClick={() => {
								const textures = getElementByDrawable(clothesArray(sex, 0), store.data.clothes.head.drawable).textures;
					...
					<div key="k_clothesBody" className="player-options-list__element select-element">
					...
					<div style={{marginBottom: '1.5vw'}} key="k_clothesBodyTexture"
					     className="player-options-list__element player-options-list__element_cloth select-element">
						<span>цвет</span>
						<div className="range-element__input">
							<img className="left-arrow" src={arrow} alt="#" onClick={() => {
							...
							<input
								type="range"
								min="0"
								max={getElementByDrawable(clothesArray(sex, 11), store.data.clothes.body.drawable)?.textures.length - 1}
								value={getElementByDrawable(clothesArray(sex, 11), store.data.clothes.body.drawable)?.textures.indexOf(store.data.clothes.body.texture)}
								onChange={(e) => {
									const textures = getElementByDrawable(clothesArray(sex, 11), store.data.clothes.body.drawable).textures;
									
									store.data.clothes.body.texture = textures[Number(e.target.value)];
								}}/>
							<img className="right-arrow" src={arrow} alt="#" onClick={() => {
								const textures = getElementByDrawable(clothesArray(sex, 11), store.data.clothes.body.drawable).textures;
					...
					<div key="k_clothesPants" className="player-options-list__element select-element">
					...
					<div style={{marginBottom: '1.5vw'}} key="k_clothesPantsTexture"
						...
						<div className="range-element__input">
							...
							<input
								type="range"
								min="0"
								max={getElementByDrawable(clothesArray(sex, 4), store.data.clothes.pants.drawable)?.textures.length - 1}
								value={getElementByDrawable(clothesArray(sex, 4), store.data.clothes.pants.drawable)?.textures.indexOf(store.data.clothes.pants.texture)}
								onChange={(e) => {
									const textures = getElementByDrawable(clothesArray(sex, 4), store.data.clothes.pants.drawable).textures;
									
									store.data.clothes.pants.texture = textures[Number(e.target.value)];
								}}/>
							<img className="right-arrow" src={arrow} alt="#" onClick={() => {
								const textures = getElementByDrawable(clothesArray(sex, 4), store.data.clothes.pants.drawable).textures;
					...
					<div key="k_clothesShoes" className="player-options-list__element select-element">
						<span>обувь</span>
						<div className="select-element__input">
							<img className="left-arrow" src={arrow} alt="#" onClick={() => {
					...
					<div key="k_clothesShoesTexture" className="player-options-list__element select-element">
						<span>цвет</span>
						<div className="range-element__input">
							<img className="left-arrow" src={arrow} alt="#" onClick={() => {
							...
							<input
								type="range"
								min="0"
								max={getElementByDrawable(clothesArray(sex, 6), store.data.clothes.shoes.drawable)?.textures.length - 1}
								value={getElementByDrawable(clothesArray(sex, 6), store.data.clothes.shoes.drawable)?.textures.indexOf(store.data.clothes.shoes.texture)}
								onChange={(e) => {
									const textures = getElementByDrawable(clothesArray(sex, 6), store.data.clothes.shoes.drawable).textures;
									
									store.data.clothes.shoes.texture = textures[Number(e.target.value)];
								}}/>
							<img className="right-arrow" src={arrow} alt="#" onClick={() => {
								const textures = getElementByDrawable(clothesArray(sex, 6), store.data.clothes.shoes.drawable).textures;
