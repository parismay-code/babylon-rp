...
const Hair = ({store}) => {
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'hair', 0, store.data.hair.head);
    }, [store.data.hair.head]);
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'hair', 2, store.data.hair.chest);
    }, [store.data.hair.chest])
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'hair', 3, store.data.hair.beard);
    }, [store.data.hair.beard]);

    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'color', 0, store.data.color.head);
    }, [store.data.color.head]);
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'color', 3, store.data.color.chest);
    }, [store.data.color.chest]);
    React.useEffect(() => {
        window.alt.emit('client::characterCreator:preview', 'color', 4, store.data.color.beard);
