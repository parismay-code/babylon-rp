			...
			<div className="job-truck-driver-content-main">
				<div className="job-truck-driver-content-main-header">
					...
					<div className="job-truck-driver-content-main-header-level">
						<div
							className="job-truck-driver-content-main-header-level__value">{store.truckDriverData.level}</div>
					...
					<div className="job-truck-driver-content-main-header-completed">
						...
						<div className="job-truck-driver-content-main-header-level__title">стоимость <br/>аренды авто
						</div>
					</div>
					<div
						className="job-truck-driver-content-main-header-button"
						onClick={() => EventManager.emitServer('jobs', 'setTruckDriverJob', !store.truckDriverData.isEmployed)}
				...
				<div className="job-truck-driver-content-main-information">
					...
					<div className="job-truck-driver-content-main-information-list">
						<div className="job-truck-driver-content-main-information-list__element">ЗП на счет в банке
						</div>
						<div className="job-truck-driver-content-main-information-list__element">Гос. работа</div>
						<div className="job-truck-driver-content-main-information-list__element">Водительское
							удостоверение
						</div>
						<div className="job-truck-driver-content-main-information-list__element">5-й игровой уровень
						</div>
					</div>
				</div>
				<div className="job-truck-driver-content-main-levels">
					...
					<div className="job-truck-driver-content-main-levels-element">
						...
						<div className="job-truck-driver-content-main-levels-element__subtitle">100 и более поездок
						</div>
					</div>
					<div className="job-truck-driver-content-main-levels-element">
						<div className="job-truck-driver-content-main-levels-element-title">
						...
						<div className="job-truck-driver-content-main-levels-element__subtitle">200 и более поездок
						</div>
					</div>
				</div>
