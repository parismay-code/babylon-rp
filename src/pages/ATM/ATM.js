...
const ATM = ({store, player, pinCode}) => {
	...
	React.useEffect(() => {
		EventManager.addHandler('atm', 'sendNotify', (text, timeout) => sendNotify(text, timeout));
	}, [sendNotify]);
	React.useEffect(() => {
		...
		EventManager.stopAddingHandlers('atm');
		
		return () => {
			EventManager.removeTargetHandlers('bank');
			EventManager.removeTargetHandlers('atm');
		}
	}, [store]);
	React.useEffect(() => {
		...
		<div className="atm-inner">
			<div className="atm-inner-navigation">
				<div className="atm-inner-navigation-card">
					...
					<div
						...
						<div className="atm-inner-navigation-card-info-bank">
							<span
								className="atm-inner-navigation-card-info-bank__name">{player.playerState.bank.name} </span>
							<span
					...
					<div className="atm-inner-navigation-card__notify"
				...
				<div
					...
					<div
						className={cn('atm-inner-navigation-main-element atm-inner-navigation-main-element_topUp', currentComponent === 'topUp' ? 'atm-inner-navigation-main-element_active' : null)}
					...
					<div
						className={cn('atm-inner-navigation-main-element', currentComponent === 'withdraw' ? 'atm-inner-navigation-main-element_active' : null)}
						onClick={() => setCurrentComponent('withdraw')}>
						<svg className="atm-inner-navigation-main-element__icon" xmlns="http://www.w3.org/2000/svg"
						     width="24.134" height="24.134"
					...
					<div
						className={cn('atm-inner-navigation-main-element', currentComponent === 'transfer' ? 'atm-inner-navigation-main-element_active' : null)}
					...
					<div
						className={cn('atm-inner-navigation-main-element', currentComponent === 'topUpMobile' ? 'atm-inner-navigation-main-element_active' : null)}
						onClick={() => {
						...
						<svg
							className="atm-inner-navigation-main-element__icon atm-inner-navigation-main-element__icon_with-stroke"
					...
					<div
						className={cn('atm-inner-navigation-main-element', currentComponent === 'taxes' ? 'atm-inner-navigation-main-element_active' : null)}
						onClick={() => {
