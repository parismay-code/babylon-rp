		...
		<div className="crime-hud-teams-attack">
			<div className="crime-hud-teams-attack-header">
				<div className="crime-hud-teams-attack-header-content" style={{backgroundColor: attackColor}}>
					<div className="crime-hud-teams-attack-header-content-info">
						<div className="crime-hud-teams-attack-header-content-info__title">{store.teams.attack.name} team</div>
					</div>
				</div>
			...
			<div className="crime-hud-teams-attack-list">
				{store.teams.attack.players.map((el, key) => {
					return <div key={key} className={cn('crime-hud-teams-attack-list-element', el.isDead ? 'crime-hud-teams-attack-list-element_dead' : null)}>
						<div className="crime-hud-teams-attack-list-element-kills" style={el.kills > 0 ? {opacity: 1} : {opacity: 0}}>
		...
		<div className="crime-hud-teams-defence">
			<div className="crime-hud-teams-defence-header">
				<div className="crime-hud-teams-defence-header-content" style={{backgroundColor: defenceColor}}>
					<div className="crime-hud-teams-defence-header-content-info">
						<div className="crime-hud-teams-defence-header-content-info__title">{store.teams.defence.name} team</div>
					</div>
				</div>
			...
			<div className="crime-hud-teams-defence-list">
				{store.teams.defence.players.map((el, key) => {
					return <div key={key} className={cn('crime-hud-teams-defence-list-element', el.isDead ? 'crime-hud-teams-defence-list-element_dead' : null)}>
						<div className="crime-hud-teams-defence-list-element-kills" style={el.kills > 0 ? {opacity: 1} : {opacity: 0}}>
