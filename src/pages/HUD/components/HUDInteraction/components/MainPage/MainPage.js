...
const MainPage = ({setCurrentPage, noVisualOption, setNoVisualOption, nextOption, setNextOption, currentOption, setCurrentOption}) => {
    ...
    const passportIcon = React.useMemo(() => {
            return <svg width="23.95" height="37.297" viewBox="0 0 23.95 37.297"
                        fill={noVisualOption === 'documents' ? '#AAB6EF' : null}
        ...
        propertyIcon = React.useMemo(() => {
            return <svg width="57.087" height="37.821" viewBox="0 0 57.087 37.821"
                        fill={noVisualOption === 'property' ? '#AAB6EF' : null}
        ...
        actionsIcon = React.useMemo(() => {
            return <svg width="30" height="30" viewBox="0 0 30 30" fill={noVisualOption === 'actions' ? '#AAB6EF' : null}
        ...
        moneyIcon = React.useMemo(() => {
            return <svg width="36.681" height="25.677" viewBox="0 0 36.681 25.677"
                        fill={nextOption === 'money' || currentOption === 'money' ? '#AAB6EF' : null}
        ...
        fractionIcon = React.useMemo(() => {
            return <svg width="27.739" height="34.37" viewBox="0 0 27.739 34.37"
                        fill={noVisualOption === 'fraction' ? '#AAB6EF' : null}
    ...
    return <div className='hud-interactions-main'>
        <div className='hud-interactions-main__title'>{titles[nextOption] ? titles[nextOption] : titles[noVisualOption] ? titles[noVisualOption] : null}</div>
