...
const ArendCar = ({currentOption, prevOption, targetPlayerData, transport}) => {
	...
	const toggleStyles = React.useMemo(() => {
		if (currentOption === 'arendCar' && !prevOption)
			return {visibility: 'visible', width: '100%', height: '100%'};
		else if (currentOption === 'arendCar' && prevOption)
			return {
				visibility: 'visible',
				width: '100%',
				height: '100%',
	...
	return <div
		className="hud-interactions-property-arend-car"
		style={toggleStyles}
	>
		...
		<div className="hud-interactions-property-arend-car-content">
			<div className="hud-interactions-property-arend-car-content-choose-transport">
				<div className="hud-interactions-property-arend-car-content-choose-transport-header">Выберите транспорт
				</div>
				<div className="hud-interactions-property-arend-car-content-choose-transport-list"
			...
			<div className="hud-interactions-property-arend-car-content-form">
				<div className="hud-interactions-property-arend-car-content-form__title">Введите сумму</div>
				<div className="hud-interactions-property-arend-car-content-form-input">
					<input
						ref={input}
						className="hud-interactions-property-arend-car-content-form-input__field"
						type="number"
						name="n_arendTransportInput"
					/>
					<div className="hud-interactions-property-arend-car-content-form-input__dollar">$</div>
					<input
						className="hud-interactions-property-arend-car-content-form-input__submit"
						type="submit"
						name="n_arendTransportSubmit"
						value="Сдать"
						onClick={() => {
							EventManager.emitServer('interaction', 'arendCar', transport[currentCar]?.name, arendTerm, input.current.value, targetPlayerData.id);
						}}
					/>
				</div>
			</div>
			<div className="hud-interactions-property-arend-car-content-info">
				<div className="hud-interactions-property-arend-car-content-info-term">
					<div className="hud-interactions-property-arend-car-content-info-term__title">Срок аренды</div>
					<div className="hud-interactions-property-arend-car-content-info-term-input">
						<img
							className="hud-interactions-property-arend-car-content-info-term-input__left-arrow"
							src={arrow}
							alt="#"
							onClick={() => {
						...
						<input
							ref={term}
							className="hud-interactions-property-arend-car-content-info-term-input__field"
							type="number"
						...
						/>
						<img
							className="hud-interactions-property-arend-car-content-info-term-input__right-arrow"
							src={arrow}
							alt="#"
							onClick={() => {
				...
				<div className="hud-interactions-property-arend-car-content-info-name">
					<div className="hud-interactions-property-arend-car-content-info-name__title">Марка</div>
					<div
						className="hud-interactions-property-arend-car-content-info-name__value">{transport[currentCar]?.name}</div>
				</div>
				<div className="hud-interactions-property-arend-car-content-info-trunk">
					<div className="hud-interactions-property-arend-car-content-info-trunk__title">Багажник</div>
					<div
						className="hud-interactions-property-arend-car-content-info-trunk__value">{transport[currentCar]?.trunk}</div>
				</div>
				<div className="hud-interactions-property-arend-car-content-info-cost">
					<div className="hud-interactions-property-arend-car-content-info-cost__title">Гос. стоимость</div>
					<div className="hud-interactions-property-arend-car-content-info-cost__value">{cost}</div>
				</div>
			</div>
		</div>
	</div>;
...
export default React.memo(ArendCar);