...
const Documents = ({setCurrentPage, noVisualOption, setNoVisualOption}) => {
    ...
    const passportIcon = React.useMemo(() => {
            return <svg width="23.95" height="37.297" viewBox="0 0 23.95 37.297"
                        fill={noVisualOption === 'passport' ? '#AAB6EF' : null}
        ...
        licenseIcon = React.useMemo(() => {
            return <svg xmlns="http://www.w3.org/2000/svg" width="27.386" height="36.152" viewBox="0 0 27.386 36.152"
                        fill={noVisualOption === 'license' ? '#AAB6EF' : null}
        ...
        certificateIcon = React.useMemo(() => {
            return <svg xmlns="http://www.w3.org/2000/svg" width="25.677" height="36.681" viewBox="0 0 25.677 36.681"
                        fill={noVisualOption === 'certificate' ? '#AAB6EF' : null}
        ...
        fracCertificateIcon = React.useMemo(() => {
            return <svg xmlns="http://www.w3.org/2000/svg" width="25.677" height="36.681" viewBox="0 0 25.677 36.681"
                        fill={noVisualOption === 'fracCertificate' ? '#AAB6EF' : null}
    ...
    return <div className='hud-interactions-documents'>
        ...
        <div className='hud-interactions-documents-options'>
            <div
                ...
                onClick={() => {
                    window.alt.emit('client::interaction:showDocuments', 'passport');
                }}
            >
                {passportIcon}
            </div>
            <div
                ...
                onClick={() => {
                    window.alt.emit('client::interaction:showDocuments', 'license');
                }}
            >
                {licenseIcon}
            </div>
            <div
                ...
                onClick={() => {
                    window.alt.emit('client::interaction:showDocuments', 'certificate');
                }}
            >
                {certificateIcon}
            </div>
            <div
                ...
                onClick={() => {
                    window.alt.emit('client::interaction:showDocuments', 'fracCertificate');
                }}
            >
                {fracCertificateIcon}
            </div>
