...
const GiveKey = ({currentOption, prevOption, targetPlayerData, transport}) => {
	...
	>
		<div className="hud-interactions-actions-give-car-key-header">
			<div className="hud-interactions-actions-give-car-key-header-nickname">
                <span
	                className="hud-interactions-actions-give-car-key-header-nickname__name">{targetPlayerData.nickname}</span>
				<div
					className="hud-interactions-actions-give-car-key-header-nickname__id">ID: {targetPlayerData.id}</div>
			</div>
		</div>
		<div className="hud-interactions-actions-give-car-key-content">
			<div className="hud-interactions-actions-give-car-key-content-choose-transport">
				<div className="hud-interactions-actions-give-car-key-content-choose-transport-header">Выберите
					транспорт
				</div>
